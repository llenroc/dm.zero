    ...
    * */
    ...
    parseImpl: function (nodeInfo, appInfo, channelInfo, contentInfo, fileInfo, callback) {
        ...
        sync.block(function () {
            ...
            //     _scope.attrs.order.value,
            //     _scope.attrs.where.value,
            //     function (err, contentInfos) {
            //         async.mapSeries(result.contentInfos, function (contentInfo, callback) {
            //             if (nodeInfo.innserXml) {
            //                 //解析内部xml
            //                 parserManager.parseContent(nodeInfo.innserXml, appInfo, channelInfo, contentInfo, fileInfo, function (err, tmpContent) {
            //                     callback(null, tmpContent);
            //                 });
            //             }
            //         }, function (err, results) {
            //             results.forEach(function (result) {
            //                 parsedContent += tmpContent;
            //             }, this);
