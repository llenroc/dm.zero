(function () {
    appModule.controller('cms.views.channels.index', [
        '$scope', '$uibModal', '$q', 'uiGridConstants', 'abp.services.app.channel', 'abp.services.app.commonLookup', 'lookupModal',
        function ($scope, $uiModal, $q, uiGridConstants, channelService, commonLookupService, lookupModal) {
            ...
            vm.channelTree = {
                ...
                getTreeDataFromServer: function (callback) {
                    channelService.getChannels({ id: abp.session.appId }).success(function (result) {
