...
namespace DM.AbpZeroTemplate.CMS.DMUsers
{
    ...
    /// </summary>
    public class DMUserEmailer : AbpZeroTemplateServiceBase, IDMUserEmailer, ITransientDependency
    {
        ...
        public DMUserEmailer(IEmailTemplateProvider emailTemplateProvider, IEmailSender emailSender,IWebUrlService webUrlService, IRepository<Tenant> tenantRepository)
        {
        ...
        /// </param>
        public async Task SendEmailActivationLinkAsync(DMUser user, string plainPassword = null)
        {
        ...
        /// </summary>
        /// <param name="user">User</param>
        public async Task SendPasswordResetLinkAsync(DMUser user)
        {
